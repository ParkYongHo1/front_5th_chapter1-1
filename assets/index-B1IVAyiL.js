...
`,L=[{id:1,name:"홍길동",createdAt:"5분 전",content:"오늘 날씨가 정말 좋네요. 다들 좋은 하루 보내세요"},{id:2,name:"박용호",createdAt:"15분 전",content:"오늘 날씨가 정말 좋네요. 다들 좋은 하루 보내세요"},{id:3,name:"김용호",createdAt:"25분 전",content:"오늘 날씨가 정말 좋네요. 다들 좋은 하루 보내세요"},{id:4,name:"이용호",createdAt:"1시간 전",content:"오늘 날씨가 정말 좋네요. 다들 좋은 하루 보내세요"},{id:5,name:"이용호",createdAt:"1시간 전",content:"오늘 날씨가 정말 좋네요. 다들 좋은 하루 보내세요"}],E={home:{id:"",content:"홈",path:"/"},profile:{id:"profile",content:"프로필",path:"/profile"},login:{id:"login",content:"로그인",path:"/login"},logout:{id:"logout",content:"로그아웃",path:"/logout"}};var a,c;class A{constructor(){g(this,a,null);g(this,c,"user");b(this,"state",{loggedIn:!1,posts:L});m(this,a,JSON.parse(localStorage.getItem(d(this,c))||"null")),this.state.loggedIn=d(this,a)!==null}setUserInfo(t){console.log(t),m(this,a,t),localStorage.setItem(d(this,c),JSON.stringify(t)),this.state.loggedIn=!0}removeUserInfo(){m(this,a,null),localStorage.removeItem(d(this,c)),this.state.loggedIn=!1}get userInfo(){return d(this,a)}getState(){return this.state}}a=new WeakMap,c=new WeakMap;const i=new A,x=()=>{const e=i.getState().loggedIn,t=E;return`
